# Hospitality & Hotel Operations Suite

Integrated hotel management system handling guest check-in, room assignments, billing calculations, restaurant charges, and check-out invoicing.
...
- **Technologies**: Python 3.11, Tkinter, SQLite / File Storage
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-hotel-management-system.git
   cd masa-hotel-management-system
   ```
